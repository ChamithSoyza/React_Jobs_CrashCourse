...
const JobListing = ({ job }) => {
  ...
  if (!showFullDescription) {
    // SLICED THE DESCRIPTION INTO SHORT 90 CHAR PARAGRAPH
    ...
    <div className="bg-white rounded-xl shadow-md relative" key={job.id}>
      <div className="p-4">
        ...
        <button
          ...
          className='text-indigo-500 hover:text-indigo-600 mb-3 bg-indigo-100  hover:bg-indigo-200 rounded-md p-1 text-sm'>
